...
def create_database():
    """Connect to PostgreSQL, drop any sparkifydb and create a new one.
    Keywords arguments:
    * None
    Output:
    ...
    * cur -- cursory to connected DB. Allows to execute SQL commands.
    ...
    conn = psycopg2.connect(host="127.0.0.1",dbname="postgres",user="postgres",password="login@123")
    ...
    conn = psycopg2.connect(host="127.0.0.1",dbname="sparkifydb",user="postgres",password="login@123")
    cur = conn.cursor()
